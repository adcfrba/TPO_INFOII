...
clean-src:
	-$(RM) ./src/aeabi_romdiv_patch.o ./src/cr_startup_lpc84x.d ./src/cr_startup_lpc84x.o ./src/crp.d ./src/crp.o ./src/i2c_driver.d ./src/i2c_driver.o ./src/main.d ./src/main.o ./src/mtb.d ./src/mtb.o
