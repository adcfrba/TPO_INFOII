...
CPP_SRCS += \
../src/GPIOLCD/gpiolcd.cpp 

CPP_DEPS += \
./src/GPIOLCD/gpiolcd.d 

OBJS += \
./src/GPIOLCD/gpiolcd.o 


# Each subdirectory must supply rules for building sources it contributes
src/GPIOLCD/%.o: ../src/GPIOLCD/%.cpp src/GPIOLCD/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-GPIOLCD

clean-src-2f-GPIOLCD:
	-$(RM) ./src/GPIOLCD/gpiolcd.d ./src/GPIOLCD/gpiolcd.o

.PHONY: clean-src-2f-GPIOLCD
