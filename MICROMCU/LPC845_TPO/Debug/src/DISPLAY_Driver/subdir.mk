...
CPP_DEPS += \
./src/DISPLAY_Driver/display.d 

OBJS += \
./src/DISPLAY_Driver/display.o 


# Each subdirectory must supply rules for building sources it contributes
src/DISPLAY_Driver/%.o: ../src/DISPLAY_Driver/%.cpp src/DISPLAY_Driver/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-DISPLAY_Driver

clean-src-2f-DISPLAY_Driver:
	-$(RM) ./src/DISPLAY_Driver/display.d ./src/DISPLAY_Driver/display.o

.PHONY: clean-src-2f-DISPLAY_Driver
