...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_Parameter2->setObjectName(QString::fromUtf8("pushButton_Parameter2"));

        gridLayout->addWidget(pushButton_Parameter2, 0, 6, 2, 2);

        pushButton_Parameter1 = new QPushButton(widget);
        pushButton_Parameter1->setObjectName(QString::fromUtf8("pushButton_Parameter1"));
        ...
        listWidget_consola->setObjectName(QString::fromUtf8("listWidget_consola"));
