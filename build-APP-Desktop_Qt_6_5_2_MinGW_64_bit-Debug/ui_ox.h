...
"color: rgb(39, 44, 84);"));
        ...
        retranslateUi(ox);
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, ox, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, ox, qOverload<>(&QDialog::reject));
