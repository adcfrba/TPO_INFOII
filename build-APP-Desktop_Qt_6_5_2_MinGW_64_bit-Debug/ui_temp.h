...
"color: rgb(39, 44, 84);"));
        ...
        retranslateUi(temp);
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, temp, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, temp, qOverload<>(&QDialog::reject));
