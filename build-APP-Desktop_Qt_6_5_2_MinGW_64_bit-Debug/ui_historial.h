...
public:
    ...
    void setupUi(QDialog *Historial)
    {
        ...
        tableView_historial->setObjectName("tableView_historial");
        ...
        buttonBox_hist->setObjectName("buttonBox_hist");
...
""));
        ...
        QObject::connect(buttonBox_hist, &QDialogButtonBox::accepted, Historial, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox_hist, &QDialogButtonBox::rejected, Historial, qOverload<>(&QDialog::reject));
