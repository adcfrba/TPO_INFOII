...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_OXI->setObjectName(QString::fromUtf8("lineEdit_OXI"));
        ...
        lineEdit_FECHA->setObjectName(QString::fromUtf8("lineEdit_FECHA"));
        ...
        pushButton_nu->setObjectName(QString::fromUtf8("pushButton_nu"));

        horizontalLayout->addWidget(pushButton_nu);

        pushButton_el = new QPushButton(centralwidget);
        pushButton_el->setObjectName(QString::fromUtf8("pushButton_el"));
